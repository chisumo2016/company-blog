...
<head>
    ...
    <title>Company Blog - IT Solution & Technology Temaptle</title>
    ...
    <link rel="stylesheet" href="{{ asset('client/assets/css/remixicon.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('client/assets/css/app.min.cs') }}s">
...
<!-- Mobile Menu -->
@include('home.partials.mobile_menu')
<!-- End mobile menu -->
...
<script src="{{ asset('client/assets/js/menu/menu.js') }}"></script>
<script src="{{ asset('client/assets/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('client/assets/js/slick.js') }}"></script>
<script src="{{ asset('client/assets/js/pricing.min.js') }}"></script>
<script src="{{ asset('client/assets/js/countdown.j') }}s"></script>
<script src="{{ asset('client/assets/js/skillbar.js') }}"></script>
<script src="{{ asset('client/assets/js/slick-animation.js') }}"></script>
<script src="{{ asset('client/assets/js/slick-animation.min.js') }}"></script>
<script src="{{ asset('client/assets/js/faq.js') }}"></script>
<script src="{{ asset('client/assets/js/isotope.pkgd.min.js') }}"></script>
<script src="{{ asset('client/assets/js/tabs-slider.js') }}"></script>
<script src="{{ asset('client/assets/js/product-increment.js') }}"></script>
<script src="{{ asset('client/assets/js/aos.js') }}"></script>
<script src="{{ asset('client/assets/js/niceselect.j') }}s"></script>
