                    ...
                    <div class="breadcrumb-menu-wrap">
                        <div class="breadcrumb-menu">
                            <ul>
                                ...
                                <li>
                                    <img src="{{ asset('client/assets/images/blog/right-arrow.svg') }}" alt="right-arrow">
                                </li>
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('blog.show' , $post->slug) }}">
                                        <img src="{{ asset('client/assets/images/blog/date.svg') }}"
                                             alt="">{{ $post->created_at->format('M d Y') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('blog.show' , $post->slug) }}">
                                        <img src="{{ asset('client/assets/images/blog/clock.svg') }}"
                                             alt=""> {{ $post->published_at->format('h:i A') }} read</a>
                                </li>
                            </ul>
                        </div>
                        <div class="lonyo-blog-d-content">
                            <h2>
                                <a href="{{ route('blog.show' , $post->slug) }}">{{ $post->title }}
                                </a>
                            </h2>
                            ...
                            @foreach( $recentPosts  as  $recentPost)
                                <a class="lonyo-blog-recent-post-item" href="single-blog.html">
                                    <div class="lonyo-blog-recent-post-thumb">
                                        <img src="{{ asset(asset($recentPost->thumbnail) ) }}" alt="" style="width: 60px; height: 100px">
                                    </div>
                                    <div class="lonyo-blog-recent-post-data">
                                        <ul>
                                            <li>
                                                <img src="{{ asset('client/assets/images/blog/date.svg') }}"
                                                     alt="">{{ $post->published_at->format('M d Y') }}
                                            </li>
                                        </ul>
                                        <div>
