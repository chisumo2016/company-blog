                        ...
                        <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                            ...
                            <div class="pt-0">
                                ...
                                <form method="POST"  action="{{ route('custom.verification.verify') }}" class="my-4">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="emailaddress"
                                               class="form-label">Verification Code ...</label>
                                        <input
                                            class="form-control"
                                            type="text"
                                            id="code"
                                ...
                                <div class="text-center text-muted mb-4">
                                    <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='{{ route('register') }}'>Sing up / Register</a></p>
                                </div>
